...
function MatterButton({
  ...
  return (
    ...
    >
      <Button
        className={cn(
          "relative h-13 overflow-hidden rounded-full border-0 bg-black px-6 text-base text-white transition-shadow duration-700 ease-in-out hover:bg-black active:translate-y-0 [a]:hover:bg-black",
          ...
          "shadow-[inset_0_-6px_8px_-1px_rgba(45,212,191,0.6)] hover:shadow-none dark:shadow-[inset_0_-3px_2px_-1px_rgba(45,212,191,0.6)] dark:hover:shadow-none",
          className,
        )}
        {...props}
      >
