      ...
      <AnimatePresence>
        {isVisible && (
          <motion.div
            ...
            className={cn(
              "pointer-events-none absolute z-50 min-w-60 overflow-hidden rounded-md border border-transparent bg-white shadow-sm ring-1 shadow-black/5 ring-black/5 dark:bg-neutral-900 dark:shadow-white/10 dark:ring-white/5",
              className,
            )}
            style={{
              top: position.y,
